...
open(20,file='./coms_le1b_ir1_ch1_cn_201601010245.bin',& 
        form='unformatted', recl=nx*ny*nbyte, access='direct',&
        convert='big_endian')
open(21,file='./coms_le1b_ir2_ch2_cn_201601010245.bin',& 
        form='unformatted', recl=nx*ny*nbyte, access='direct',&
        convert='big_endian')
open(22,file='./coms_le1b_wv_ch3_cn_201601010245.bin',& 
        form='unformatted', recl=nx*ny*nbyte, access='direct',&
        convert='big_endian')
open(23,file='./coms_le1b_swir_ch4_cn_201601010245.bin',& 
        form='unformatted', recl=nx*ny*nbyte, access='direct',&
        convert='big_endian')
open(24,file='./coms_le1b_vis_ch5_cn_201601010245.bin',& 
        form='unformatted', recl=nx*ny*nbyte, access='direct',&
        convert='big_endian')
...
open(10,file='./coms_mi_conversion_table_new_v2.dat')
open(11,file='./coms_mi_conversion_table_rad.dat')

do i=1, sizeofctab
	read(10,'(4(F8.4,2x),F8.4)') tb(i,1), tb(i,2), tb(i,3), tb(i,4), tb(i,5)
	read(11,'(4(ES11.5,x),ES11.5)') rad(i,1), rad(i,2), rad(i,3), rad(i,4), rad(i,5)
enddo 
